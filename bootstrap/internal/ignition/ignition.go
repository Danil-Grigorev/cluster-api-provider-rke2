...
var (
	serverDeployCommands = []string{
		...
		"kubectl create secret tls $(hostname)-etcd -n kube-system --cert=/var/lib/rancher/rke2/server/tls/etcd/client.crt --key=/var/lib/rancher/rke2/server/tls/etcd/client.key --kubeconfig /var/lib/rancher/rke2/server/cred/api-server.kubeconfig",
